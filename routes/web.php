...
Route::get('/mydevotional/datedisplaytoday', 'WelcomeController@datedisplaytoday');
Route::get('/mydevotional/topsharing', 'WelcomeController@topsharing');
Route::get('/mydevotional/topreading', 'WelcomeController@topreading');
Route::get('/mydevotional/bookmark', 'WelcomeController@bookmark');
Route::get('/guestdevotional/{id}', 'WelcomeController@devotional');
Route::get('/guestdevotional/datedisplayguest', 'WelcomeController@datedisplayguest');
Route::get('/guestdevotional/datedisplaytodayguest', 'WelcomeController@datedisplaytodayguest');
Route::get('/guestdevotional/topsharingguest', 'WelcomeController@topsharingguest');
Route::get('/guestdevotional/topreadingguest', 'WelcomeController@topreadingguest');
// Route::get('/guestdevotional/{id}', 'WelcomeController@datedisplayguest');
...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    Route::get('/edit-guest/delete/{id}', 'GuestController@guestdelete')->middleware(['cek' => 'cek:all']);
    Route::get('/edit-guest/delete/', 'GuestController@guestdelete')->middleware(['cek' => 'cek:all']);
    ...
    Route::get('/profile/member_change_picture/{id}', 'ProfileController@change_picture')->middleware(['cek' => 'cek:all']);
    Route::post('/profile/member_change_picture/{id}', 'ProfileController@picturestore')->middleware(['cek' => 'cek:all']);
    // Tambah data
...
/* Marker / Coordinate related */
Route::get('/membercoordinate', 'MemberCoordinateController@index');
