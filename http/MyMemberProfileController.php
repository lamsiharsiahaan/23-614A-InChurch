...
class MyMemberProfileController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        $profile = DB::select("CALL sp_chc_member ('sel_profile','$temph1','$temph2','$temph3','$temph4','$id_member','$ip','$browser','','','','$id','','','','','','','','','','','','','','','','','','','') ");
        // dd($profile);
        ...
        } elseif (empty($profile[0])) {
            // echo "<script>alert('data tidak ditemukan')</script>";
            return Redirect::back()->with('error', 'Data tidak ditemukan');
        }
        // dd($ministry);

        return view('mymemberprofile', compact('profile', 'education', 'expertise', 'occupation', 'commission', 'ministry', 'listedu', 'listoccup', 'listexpertise', 'listcommission', 'listministry'));
    }
    ...
    public function education_detail($id)
    {
        ...
        return view('mymemberprofile.edit_edu', compact('listedu', 'data'));
    }
    ...
    public function self_desc()
    {
        ...
        return view('mymemberprofile.edit_self', compact('data'));
    }
    ...
    public function selfstore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#page')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function selfdelete(Request $request)
    {
        ...
        DB::select("CALL sp_chc_member ('del_profile_selfdescription_one','$temph1','$temph2','$temph3','$temph4','$id_member','$ip','$browser','','','','$id_member
            ','','','','','','','','','','','','','','','','','','','')");
        return redirect('mymemberprofile/#page')->with(['success' => 'Data berhasil hapus!']);
    }
    ...
    public function member()
    {
        ...
        return view('mymemberprofile.edit_member', compact('data', 'membertype'));
    }
    ...
    public function memberstore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagemember')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function contact()
    {
        ...
        return view('mymemberprofile.edit_contact', compact('data', 'data'));
    }
    ...
    public function storecontact(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagecontact')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function address()
    {
        ...
        return view('mymemberprofile.edit_address', compact('data', 'city', 'country', 'province'));
    }
    ...
    public function storeaddress(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageaddress')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function family()
    {
        ...
        return view('mymemberprofile.edit_family', compact('data', 'member', 'family', 'marriage'));
    }
    ...
    public function storefamily(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagefamily')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function commission($id)
    {
        ...
        return view('mymemberprofile.edit_commission', compact('data', 'commission'));
    }
    ...
    public function storecommission(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagecommission')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function setting()
    {
        ...
        return view('mymemberprofile.edit_setting', compact('data', 'commission', 'termination', 'level', 'church', 'field'));
    }
    ...
    public function storesetting(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagesetting')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function socialmedia()
    {
        ...
        return view('mymemberprofile.edit_socialmedia', compact('data'));
    }
    ...
    public function storesocialmedia(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pagesocialmedia')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function info()
    {
        ...
        return view('mymemberprofile.edit_info', compact('data', 'gender', 'blood', 'city', 'ethnic', 'region', 'sector', 'pooling', 'wind'));
    }
    ...
    public function infostore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageinfo')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function ministry($id)
    {
        ...
        return view('mymemberprofile.edit_ministry', compact('data', 'ministry'));
    }
    ...
    public function ministrystore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageministry')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function occupation($id)
    {
        ...
        return view('mymemberprofile.edit_occupation', compact('data', 'occupation'));
    }
    ...
    public function occupationstore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageoccupation')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function expertise($id)
    {
        ...
        return view('mymemberprofile.edit_expertise', compact('data', 'expertise'));
    }
    ...
    public function expertisestore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageexpertise')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function educationstore(Request $request)
    {
        ...
        return redirect('mymemberprofile/#pageeducation')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    public function educationdelete($id)
    {
        ...
        return redirect('mymemberprofile/#pageeducation')->with(['success' => 'Data berhasil hapus!']);
    }
    ...
    public function ministrydelete($id)
    {
        ...
        return redirect('mymemberprofile/#pageministry')->with(['success' => 'Data berhasil hapus!']);
    }
    ...
    public function expertisedelete($id)
    {
        ...
        return redirect('mymemberprofile/#pageexpertise')->with(['success' => 'Data berhasil hapus!']);
    }
    ...
    public function commissiondelete($id)
    {
        ...
        return redirect('mymemberprofile/#pagecommission')->with(['success' => 'Data berhasil hapus!']);
    }
    ...
    public function occupationdelete($id)
    {
        ...
        return redirect('mymemberprofile/#pageoccupation')->with(['success' => 'Data berhasil hapus!']);
    }
}
